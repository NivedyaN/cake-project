    	...
    	<div class="row">
            <div class="col-md-12">
                <table  border="1" class="table" style="margin-top:100px;">
                    <tr>
                        <h1><center><b><font color="green">VIEW DELIVERY</b></center></h1>
...
<?php
    ...
    $actions=array(
       'edit'=>array('label'=>'deliver','link'=>'delivery.php','params'=>array('id'=>'bid'),'attributes'=>array('class'=>'btn btn-success')),
    );
