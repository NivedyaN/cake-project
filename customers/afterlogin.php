...
<head>
    ...
    <!-- Site Metas -->
    <title>online cake booking after login</title>
    ...
    <link rel="shop" href="images/shop.jpg">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="images/shop.jpg" class="logo" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item"><a class="nav-link" href="category_seller.php">Home</a></li>
                       <li class="nav-item"><a class="nav-link" href="logout.php">Logout</a></li>
                       
                        <!--<li class="nav-item"><a class="nav-link" href="customize.php">customize</a></li>-->
                        <li class="nav-item"><a class="nav-link" href="reportbooking.php">Booked items</a></li>
                        <li class="nav-item"><a class="nav-link" href="reportdelivery.php">Delivered items</a></li>
                        <li class="nav-item"><a class="nav-link" href="reportcancel.php">Cancelled items</a></li>
